"""
Django settings for tokenmgmtsys project.
...
ROOT_URLCONF = 'tokenmgmtsys.urls'
...
APPLICATION = config("APPLICATION", default="WSGI")

if APPLICATION == "ASGI":
    ASGI_APPLICATION = 'tokenmgmtsys.asgi.application'
else:
